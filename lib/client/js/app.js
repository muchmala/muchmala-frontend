$(function() {
    ...
    var menuDialog      = new Puzz.Views.MenuDialog(twentyCollection);
    var noPuzzlesDialog = new Puzz.Views.NoPuzzlesDialog(createDialog);
    var completeDialog  = new Puzz.Views.CompleteDialog(puzzleModel, leadersCollection);
    
    var panelView = new Puzz.Views.Panel({
    ...
    var viewport = new Puzz.Views.Viewport(puzzleModel, panelView);
    ...
    server.bind(MESSAGES.noPuzzles, function() {
        noPuzzlesDialog.show();
        panelView.loadingComplete();
    });

    puzzleModel.once('change', function() {
        if (puzzleModel.get('completion') == 100) {
            menuDialog.hide();
            menuDialog.bind('hidden', function() {
                completeDialog.show();
            });
        }
