...
Proto.select = function() {
    if (!this.isCollected() && !this.locked && !this.selected) {
...
Proto.highlight = function() {
    if (!this.isCollected() && !this.locked && !this.selected && !this.highlighted) {
...
Proto.removeBorders = function() {
    _.each(this.borders, function(border) {
        border.vert.remove();
        border.horz.remove();
    });
    this.borders = {};
