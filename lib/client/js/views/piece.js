...
Proto.createBorder = function(color) {
    ...
    $(this.canvas).after(this.border.vert);
    $(this.canvas).after(this.border.horz);
};

Proto.removeBorder = function() {
    if (this.border) {
        this.border.vert.remove();
        this.border.horz.remove();
    }
};
