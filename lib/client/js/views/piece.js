...
Proto.select = function() {
    this.removeBorder(Piece.HIGHLIGHTED_BORDER_COLOR);
    this.createBorder(Piece.SELECTED_BORDER_COLOR);
    this.selected = true;
    this.render();
};
Proto.lock = function(title) {
    this.createBorder(Piece.LOCKED_BORDER_COLOR);
    this.locked = true;
    this.render();
};
Proto.highlight = function() {
    this.createBorder(Piece.HIGHLIGHTED_BORDER_COLOR);
    this.highlighted = true;
    this.render();
};
Proto.unselect = function() {
    this.removeBorder(Piece.SELECTED_BORDER_COLOR);
    this.selected = false;
    this.render();
};
Proto.unlock = function() {
    this.removeBorder(Piece.LOCKED_BORDER_COLOR);
    this.locked = false;
    this.render();
};
...
Proto.createBorder = function(color, foreground) {
    var border = {
    ...
    this.borders[color] = border;
};

Proto.removeBorder = function(color) {
    if (!_.isUndefined(this.borders[color])) {
        this.borders[color].vert.remove();
        this.borders[color].horz.remove();
        delete this.borders[color];
    }
};
